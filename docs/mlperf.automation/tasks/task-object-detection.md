...
```
ck install package --tags=model,object-detection,mlperf,onnx,ssd-mobilenet,opset-8
```
...
```
ck install package --tags=model,object-detection,mlperf,onnx,ssd-mobilenet,opset-11
```

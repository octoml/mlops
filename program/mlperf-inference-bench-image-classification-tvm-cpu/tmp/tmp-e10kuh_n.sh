...
. /home/gfursin/CK/local/venv/mlperf-inference/CK/local/env/ebe647288e27430e/env.sh

export CK_LOADGEN_ACCURACY=on
export CK_LOADGEN_OPTS=
export CK_LOADGEN_SCENARIO=Offline
export CK_MLPERF_BACKEND=tvm
export CK_MLPERF_DEVICE=cpu
export EXTRA_OPS="--count 10 --thread 1 --max-batchsize 1"

export CK_MLPERF_MODEL=resnet50
export CK_LOADGEN_ASSEMBLED_OPTS="--accuracy  --output /home/gfursin/CK/local/venv/mlperf-inference/CK/octoml@mlops/program/mlperf-inference-bench-image-classification-tvm-cpu/tmp"
